 ...
 * Health API v4 (health.googleapis.com), the successor to the Fitbit Web
 * API that shuts down 2026-09. Responses are adapted back into the
 * Fitbit-era shapes the tool layer expects, so the tools are untouched.
 */
