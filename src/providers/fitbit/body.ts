...
export async function deleteWeightLog(client: FitbitClient, logId: string): Promise<void> {
...
export async function deleteBodyFatLog(client: FitbitClient, logId: string): Promise<void> {
  await client.requestText({
