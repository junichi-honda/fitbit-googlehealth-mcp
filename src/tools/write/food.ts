  ...
  server.registerTool(
    'log_meal_photo',
    {
      ...
      description: [
        ...
        '- ALWAYS include macros (`protein` / `carbs` / `fat`) in grams by',
        '  default: estimate them from the visible portion combined with your',
        '  own nutrition knowledge. Only leave a macro undefined if it is',
        '  genuinely inestimable.',
